...
const moon = (fill) => (
  ...
  >
    <path
      fill={fill}
      d="M367.924,8.521c70.94,127.548,25.05,288.445-102.49,359.385c-79.869,44.425-177.026,44.425-256.895,0
    ...
    <path
      fill={fill}
      d="M239.353,511.984c-98.886-0.077-190.011-53.592-238.252-139.92
...
const ThemeSwitcher = ({ onClick }) => {
  ...
  return (
    <div styleName={`themeSwitcher`} onClick={onClick} data-for="themeAlt" data-tip>
